OBJECT_FILES = build/entry.asm.o build/ioport.asm.o build/alarm.o build/signal.o build/process.o build/gdt.o build/console.o build/traps.o build/main.o build/keyboard.o build/string.o build/printk.o
